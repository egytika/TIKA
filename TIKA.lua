...
print('\n\27[1;34m Welcome to the all-new and powerful Source TIKA ')
file = io.open("TIKA", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/TIKA
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TIKA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevTIKAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
TIKA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TIKA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TIKA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TIKA_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceTIKA(msg,data) -- بداية العمل
if msg then
...
SourceTIKAr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/TIKA_EGYPT)'
end 
send(msg.chat_id_, msg.id_, SourceTIKAr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevTIKAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTIKAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,TIKA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevTIKAW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevTIKAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevTIKAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevTIKAW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevTIKAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevTIKAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevTIKAW(msg) then 
...
if text == 'تحديث السورس ❃' and DevTIKAW(msg) then 
os.execute('rm -rf TIKA.lua')
os.execute('wget https://raw.githubusercontent.com/TIKATEAM/TIKA/master/TIKA.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس تيكا\n ❃∫ الاصدار » { 6.7v}')
dofile('TIKA.lua')  
end
if text == 'تحديث المتجر ❃' and DevTIKAW(msg) then 
  io.popen("mkdir File_Bot")
  io.popen("cd File_Bot && rm -rf ga.lua.1") 
  io.popen("cd File_Bot && rm -rf ga.lua.2") 
  io.popen("cd File_Bot && rm -rf ga.lua.3") 
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TIKATEAM/Files_TIKA/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TIKATEAM/Files_TIKA/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('TIKA.lua')  
  end
if text == 'رقم البناء ❃' and DevTIKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevTIKAW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس تيكا \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevTIKAW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @JJEJJ ')
    end
if text == 'قناه تحديثات البوت ❃' and DevTIKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/TIKA_EGYPT) \n ❃∫ [قناه السورس](t.me/TIKA_EGYPT)')
end
if text == "ضع اسم للبوت ❃" and DevTIKAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevTIKAW(msg) then 
...
if text == 'المشتركين ❃' and DevTIKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevTIKAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevTIKAW(msg) then
...
if text == ("قائمه العام ❃") and DevTIKAW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevTIKAW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevTIKAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevTIKAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevTIKAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevTIKAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevTIKAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevTIKAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevTIKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevTIKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..TIKAk..''..TIKA..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTIKAW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevTIKAW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTIKAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTIKAW(msg) then
...
local TIKA1_Msg = database:get(bot_id.."TIKA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TIKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if TIKA_Msg and not Special(msg) then  
local TIKA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TIKA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TIKA_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](t.me/TIKA_EGYPT)}\n ❃∫ ["..TIKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](t.me/TIKA_EGYPT)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTIKAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTIKAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTIKAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTIKAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevTIKAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevTIKAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevTIKAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevTIKAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevTIKAW(msg) then  
...
database:sadd(bot_id.."TIKA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."TIKA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_TIKA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_TIKA then 
names_TIKA = database:smembers(bot_id.."TIKA:blocname"..msg.chat_id_) or ""
if names_TIKA and names_TIKA[1] then 
for i=1,#names_TIKA do 
if name_TIKA:match("(.*)("..names_TIKA[i]..")(.*)") then 
...
database:set(bot_id.."TIKA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."TIKA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."TIKA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."TIKA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."TIKA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_TIKAa_new(TIKA1,TIKA2)
if TIKA2 and TIKA2.first_name_ then 
if TIKA2.first_name_:match("(.*)"..database:get(bot_id.."TIKA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TIKA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local TIKA_nnn = database:get(bot_id.."TIKA:nump"..msg.chat_id_) or 5
local TIKA_nnn2 = database:get(bot_id.."TIKA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(TIKA_nnn2) == tonumber(TIKA_nnn) or tonumber(TIKA_nnn2) > tonumber(TIKA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."TIKA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..TIKA2.username_.."](https://t.me/"..(TIKA2.username_ or "BO6OK")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."TIKA:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(TIKA_nnn) - tonumber(TIKA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_TIKAa_new)
end
end
...
local TIKAChengName = database:get(bot_id.."TIKA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TIKAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TIKAChengName..']')
database:del(bot_id.."TIKA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TIKAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."TIKA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TIKAChengUserName = database:get(bot_id.."TIKA:Cheng:UserName"..data.id_)
if not data.username_ then 
if TIKAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TIKAChengUserName..']')
database:del(bot_id.."TIKA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TIKAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."TIKA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TIKAChengPhoto = database:get(bot_id.."TIKA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TIKAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."TIKA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TIKAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."TIKA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
  ...
  ↬ .TIKA TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/TIKA_EGYPT)  
  
  ↬ . [DEVELOPER](t.me/JJEJJ)       
   
  ↬ . [Information](t.me/TIKA_EGYPT) 
...
if text == 'رفع نسخه الاحتياطيه' and DevTIKAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BO6OK')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BO6OK')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevTIKAW(msg) then    
dofile('TIKA.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevTIKAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTIKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevTIKAW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevTIKAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTIKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevTIKAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevTIKAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTIKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevTIKAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTIKAW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevTIKAW(msg) then
...
if text == 'الملفات' and DevTIKAW(msg) then
t = ' ❃∫ ملفات السورس تيكا ↓\n≪━━━━━━𝐓𝐊━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevTIKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TIKATEAM/Files_TIKA/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات تيكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝐓𝐊━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝐓𝐊━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس تيكا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/TIKA_EGYPT) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTIKAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TIKATEAM/Files_TIKA/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TIKA.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس تيكا \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTIKAW(msg) then
...
if text == "مسح الملفات" and DevTIKAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTIKAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTIKAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_TIKA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TIKA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TIKA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BO6OK')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BO6OK')..')'
...
database:set(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TIKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TIKA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TIKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TIKA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TIKA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TIKA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TIKA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TIKA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TIKA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TIKA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TIKA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝐓𝐊━━━━━━≫\n"
for k,v in pairs(list) do  
local TIKA_Msg = database:get(bot_id.."TIKA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TIKA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevTIKAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevTIKAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BO6OK')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevTIKAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTIKAW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيكا')
local TIKA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..TIKA_Msg[math.random(#TIKA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTIKAW(msg) then 
...
if text == ("مسح ردود المطور") and DevTIKAW(msg) then 
...
if text == ("ردود المطور") and DevTIKAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝐓𝐊━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTIKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevTIKAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيكا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevTIKAW(msg) then   
...
if text == 'تعطيل المغادره' and DevTIKAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TIKA')..') '
...
-- vardump(data) 
TIKAdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTIKAW(msg) then
...
return false
  ...
  local Text =[[
    ...
    *❃م10 ◂ اوامر الاعضاء*
    ٴ≪━━━━━━𝐓𝐊━━━━━━≫ٴ
    彡 .[𝑇𝐼𝐾𝐴 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/TIKA_EGYPT)➢ 
  ]]
  keyboard = {} 
  ...
  {
  {text = '𝐓𝐈𝐊𝐀 {𝐓} 𝐓𝐄𝐀𝐌', url="t.me/TIKA_EGYPT"},
  },
  }
...
zh = https.request('https://rudi-dev.tk/Amir1/TIKA.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝐓𝐊━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝐓𝐊━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝑇𝐼𝐾𝐴 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/TIKA_EGYPT)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/TIKA.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/TIKA.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيكا')
...
TIKA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TIKA)
...
------------------------------------------------------------------------
local TIKAAbot = database:get(bot_id.."TIKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if TIKAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TIKAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TIKA1_Msg = database:get(bot_id.."TIKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if TIKA1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..TIKA1_Msg)
